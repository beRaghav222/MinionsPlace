<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" CodeFile="ManageExpense.aspx.cs" Inherits="admin_ManageExpense" %>
		 ...
		 <!-- Form -->
			<div>
             ...
             <div>
              ...
              <div>
					<label>
                        <asp:TextBox ID="txtexpenditure" required="" placeholder="Expenditure"    runat="server" OnTextChanged="txtexpenditure_TextChanged"></asp:TextBox>
